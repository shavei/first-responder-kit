 ...
 *
 * Shared by the metronome screen and the settings screen so the range, the step size and
 * the look of the control are defined exactly once.
 */
@Composable
fun BpmStepper(
    bpm: Int,
    ...
    Row(
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Text(
                text = "${Bpm.MIN}–${Bpm.MAX} ${stringResource(R.string.bpm_unit)}",
